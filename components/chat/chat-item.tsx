...
/* export const UpdateUserProfile = async () => {
  ...
  if(profile?.imageUrl !== user?.imageUrl){
    const urlPro = `${profile?.imageUrl}`
    await axios.patch(urlPro, user?.imageUrl);
  }
}; */
...
export const ChatItem = ({
  ...
  const isUrlContent = !isPDF && !isVideo && !isImage &&content && content.startsWith("https://") ; 
        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <Button
              ...
              className="h-140 w-160 bg-0 border-0 hover:bg-0 "
            >
              <Image
                src={fileUrl}
                alt="Button Image"
          ...
          {!fileUrl && !isEditing && !isUrlContent && (
            <p
              className={cn(
                "text-sm text-zinc-60",
            ...
            <Form {...form}>
              ...
              >
                <FormField
                  ...
                  name="content"
                  render={({ field }) => (
                    <FormItem className="flex-1 w-80">
                      <FormControl>
